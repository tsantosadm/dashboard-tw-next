...
const UsedSpaceWidget = () => {
    return (
        ...
        <div className="space-y-1">
            ...
            <p className="text-ms/5 text-violet-500">
        ...
        <div className="space-x-3">
            <button type="button" className="text-sm font-medium hover:text-violet-700">Dismiss</button>
            <button type="button" className="text-sm font-medium hover:text-violet-900">Upgrade Plan</button>
        </div>
    </div>
    )
}

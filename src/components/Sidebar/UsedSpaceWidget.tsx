...
const UsedSpaceWidget = () => {
    return (
        ...
        <div className="space-y-1">
            ...
            <p className="text-ms/5 text-violet-500 dark:text-zinc-400">
        ...
        <div className="space-x-3">
            <button type="button" className="text-sm font-medium hover:text-violet-700 dark:text-violet-300 dark:hover:text-violet-300">Dismiss</button>
            <button type="button" className="text-sm font-medium hover:text-violet-900 dark:text-zinc-300 dark:hover:text-zinc-200">Upgrade Plan</button>
        </div>
    </div>
    )
}

...
export function TabItem({value, title, isSelected = false}: TabItemProps){
    return (
        <Tabs.Trigger value={value} className='group outline-none relative px-1 pb-4 text-sm font-medium text-zinc-500 dark:text-zinc-400 dark:data-[state=active]:text-violet-300 hover:text-violet-700 dark:hover:text-violet-300 data-[state=active]:text-violet-700'>

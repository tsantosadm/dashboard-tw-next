...
export function Select({ children, placeholder, ...props }: SelectProps){
    return (
        ...
        <SelectPrimitive.Portal>
            <SelectPrimitive.Content side='bottom' sideOffset={6} position='popper' className='z-10 shadow-sm rounded-lg border border-zinc-200 bg-white w-[--radix-select-trigger-width] overflow-hidden animate-slideDownAndFade dark:border-zinc-700 dark:bg-zinc-800'>
